module.exports = function(client) {
  ...
  client.query(`INSERT INTO property__c (name, thumbnail__c, beds__c, location__longitude__s, address__c, baths__c, broker__c, description__c, sfid, state__c, city__c, zip__c, title__c, picture__c, price__c, location__latitude__s) VALUES ('Marszałkowska 57', 'https://s3-us-west-1.amazonaws.com/sfdc-demo/realty/house01sq.jpg', 3, 21.0130514, 'Marszałkowska 57', 2, 'a0036000003SsJwAAK', 'Lorem ipsum dolor sit amet', 'a0236000002NHKoAAO', 'Mazowieckie', 'Warszawa', '00-527', 'abc', 'https://cdn.pixabay.com/photo/2017/08/10/05/06/condo-2618421_960_720.jpg', 720000, 52.2262339);`);
